...
public class FileDescriptorProto : Protobuf.Message
{
    ...
    public List<Protobuf.DescriptorProto> message_type;
    public List<Protobuf.EnumDescriptorProto> enum_type;
    public List<Protobuf.ServiceDescriptorProto> service;
    public List<Protobuf.FieldDescriptorProto> extension;
    public Protobuf.FileOptions? options;
    public Protobuf.SourceCodeInfo? source_code_info;
    ...
    public FileDescriptorProto ()
    {
        ...
        this.message_type = new List<Protobuf.DescriptorProto> ();
        this.enum_type = new List<Protobuf.EnumDescriptorProto> ();
        this.service = new List<Protobuf.ServiceDescriptorProto> ();
        this.extension = new List<Protobuf.FieldDescriptorProto> ();
        this.options = null;
    ...
    public override bool decode (Protobuf.DecodeBuffer buffer, ssize_t data_length = -1)
    {
        ...
        while (buffer.read_index < end)
        {
            ...
            if (field_number == 1 && wire_type == 2)
                ...
                this.message_type.append (new Protobuf.DescriptorProto.from_data (buffer, (ssize_t) buffer.decode_varint ()));
            else if (field_number == 5 && wire_type == 2)
                this.enum_type.append (new Protobuf.EnumDescriptorProto.from_data (buffer, (ssize_t) buffer.decode_varint ()));
            else if (field_number == 6 && wire_type == 2)
                this.service.append (new Protobuf.ServiceDescriptorProto.from_data (buffer, (ssize_t) buffer.decode_varint ()));
            else if (field_number == 7 && wire_type == 2)
                this.extension.append (new Protobuf.FieldDescriptorProto.from_data (buffer, (ssize_t) buffer.decode_varint ()));
            else if (field_number == 8 && wire_type == 2)
                this.options = new Protobuf.FileOptions.from_data (buffer, (ssize_t) buffer.decode_varint ());
            else if (field_number == 9 && wire_type == 2)
                this.source_code_info = new Protobuf.SourceCodeInfo.from_data (buffer, (ssize_t) buffer.decode_varint ());
            else
                this.unknown_fields.prepend (buffer.decode_unknown_field (key));
        }
    ...
    public override size_t encode (Protobuf.EncodeBuffer buffer)
    {
        ...
        for (unowned List<Protobuf.FieldDescriptorProto> i = this.extension.last (); i != null; i = i.prev)
        {
        ...
        for (unowned List<Protobuf.ServiceDescriptorProto> i = this.service.last (); i != null; i = i.prev)
        {
        ...
        for (unowned List<Protobuf.EnumDescriptorProto> i = this.enum_type.last (); i != null; i = i.prev)
        {
        ...
        for (unowned List<Protobuf.DescriptorProto> i = this.message_type.last (); i != null; i = i.prev)
        {
    ...
    public override string to_string (string indent = "")
    {
        ...
        foreach (unowned Protobuf.DescriptorProto v in this.message_type)
        {
            text += indent + "message_type {\n";
            text += "%s".printf (v.to_string (indent + "  "));
            text += indent + "}\n";
        }
        foreach (unowned Protobuf.EnumDescriptorProto v in this.enum_type)
        {
            text += indent + "enum_type {\n";
            text += "%s".printf (v.to_string (indent + "  "));
            text += indent + "}\n";
        }
        foreach (unowned Protobuf.ServiceDescriptorProto v in this.service)
        {
            text += indent + "service {\n";
            text += "%s".printf (v.to_string (indent + "  "));
            text += indent + "}\n";
        }
        foreach (unowned Protobuf.FieldDescriptorProto v in this.extension)
        {
...
public class DescriptorProto : Protobuf.Message
{
    ...
    public string name;
    public List<Protobuf.FieldDescriptorProto> field;
    public List<Protobuf.FieldDescriptorProto> extension;
    public List<Protobuf.DescriptorProto> nested_type;
    public List<Protobuf.EnumDescriptorProto> enum_type;
    public List<Protobuf.DescriptorProto.ExtensionRange> extension_range;
    public Protobuf.MessageOptions? options;

    public DescriptorProto ()
    {
        this.name = "";
        this.field = new List<Protobuf.FieldDescriptorProto> ();
        this.extension = new List<Protobuf.FieldDescriptorProto> ();
        this.nested_type = new List<Protobuf.DescriptorProto> ();
        this.enum_type = new List<Protobuf.EnumDescriptorProto> ();
        this.extension_range = new List<Protobuf.DescriptorProto.ExtensionRange> ();
        this.options = null;
    }
    ...
    public override bool decode (Protobuf.DecodeBuffer buffer, ssize_t data_length = -1)
    {
        ...
        while (buffer.read_index < end)
        {
            ...
            if (field_number == 1 && wire_type == 2)
                ...
                this.field.append (new Protobuf.FieldDescriptorProto.from_data (buffer, (ssize_t) buffer.decode_varint ()));
            else if (field_number == 6 && wire_type == 2)
                this.extension.append (new Protobuf.FieldDescriptorProto.from_data (buffer, (ssize_t) buffer.decode_varint ()));
            else if (field_number == 3 && wire_type == 2)
                this.nested_type.append (new Protobuf.DescriptorProto.from_data (buffer, (ssize_t) buffer.decode_varint ()));
            else if (field_number == 4 && wire_type == 2)
                this.enum_type.append (new Protobuf.EnumDescriptorProto.from_data (buffer, (ssize_t) buffer.decode_varint ()));
            else if (field_number == 5 && wire_type == 2)
                this.extension_range.append (new Protobuf.DescriptorProto.ExtensionRange.from_data (buffer, (ssize_t) buffer.decode_varint ()));
            else if (field_number == 7 && wire_type == 2)
                this.options = new Protobuf.MessageOptions.from_data (buffer, (ssize_t) buffer.decode_varint ());
            else
                this.unknown_fields.prepend (buffer.decode_unknown_field (key));
        }
    ...
    public override size_t encode (Protobuf.EncodeBuffer buffer)
    {
        ...
        for (unowned List<Protobuf.DescriptorProto.ExtensionRange> i = this.extension_range.last (); i != null; i = i.prev)
        {
        ...
        for (unowned List<Protobuf.DescriptorProto> i = this.nested_type.last (); i != null; i = i.prev)
        {
        ...
        for (unowned List<Protobuf.FieldDescriptorProto> i = this.field.last (); i != null; i = i.prev)
        {
    ...
    public override string to_string (string indent = "")
    {
        ...
        text += indent + "name: %s\n".printf (Protobuf.string_to_string (this.name));
        foreach (unowned Protobuf.FieldDescriptorProto v in this.field)
        {
            text += indent + "field {\n";
            text += "%s".printf (v.to_string (indent + "  "));
            text += indent + "}\n";
        ...
        foreach (unowned Protobuf.DescriptorProto v in this.nested_type)
        {
        ...
        foreach (unowned Protobuf.DescriptorProto.ExtensionRange v in this.extension_range)
        {
...
public class FieldDescriptorProto : Protobuf.Message
{
    ...
    public string name;
    public int32 number;
    public Protobuf.FieldDescriptorProto.Label label;
    public Protobuf.FieldDescriptorProto.Type type;
    public string type_name;
    public string extendee;
    public string default_value;
    public Protobuf.FieldOptions? options;
    ...
    public override bool decode (Protobuf.DecodeBuffer buffer, ssize_t data_length = -1)
    {
        ...
        while (buffer.read_index < end)
        {
            ...
            if (field_number == 1 && wire_type == 2)
                ...
                this.label = (Protobuf.FieldDescriptorProto.Label) buffer.decode_varint ();
            else if (field_number == 5 && wire_type == 0)
                this.type = (Protobuf.FieldDescriptorProto.Type) buffer.decode_varint ();
            else if (field_number == 6 && wire_type == 2)
                ...
                this.options = new Protobuf.FieldOptions.from_data (buffer, (ssize_t) buffer.decode_varint ());
            else
                this.unknown_fields.prepend (buffer.decode_unknown_field (key));
        }
    ...
    public override string to_string (string indent = "")
    {
        ...
        text += indent + "label: %s\n".printf (Protobuf.FieldDescriptorProto.Label_to_string (this.label));
        text += indent + "type: %s\n".printf (Protobuf.FieldDescriptorProto.Type_to_string (this.type));
...
{
    public string name;
    public List<Protobuf.EnumValueDescriptorProto> value;
    public Protobuf.EnumOptions? options;

    public EnumDescriptorProto ()
    {
        this.name = "";
        this.value = new List<Protobuf.EnumValueDescriptorProto> ();
        this.options = null;
    }
    ...
    public override bool decode (Protobuf.DecodeBuffer buffer, ssize_t data_length = -1)
    {
        ...
        while (buffer.read_index < end)
        {
            ...
            if (field_number == 1 && wire_type == 2)
                ...
                this.value.append (new Protobuf.EnumValueDescriptorProto.from_data (buffer, (ssize_t) buffer.decode_varint ()));
            else if (field_number == 3 && wire_type == 2)
                this.options = new Protobuf.EnumOptions.from_data (buffer, (ssize_t) buffer.decode_varint ());
            else
                this.unknown_fields.prepend (buffer.decode_unknown_field (key));
        }
    ...
    public override size_t encode (Protobuf.EncodeBuffer buffer)
    {
        ...
        for (unowned List<Protobuf.EnumValueDescriptorProto> i = this.value.last (); i != null; i = i.prev)
        {
    ...
    public override string to_string (string indent = "")
    {
        ...
        text += indent + "name: %s\n".printf (Protobuf.string_to_string (this.name));
        foreach (unowned Protobuf.EnumValueDescriptorProto v in this.value)
        {
            text += indent + "value {\n";
            text += "%s".printf (v.to_string (indent + "  "));
            text += indent + "}\n";
...
public class EnumValueDescriptorProto : Protobuf.Message
{
    public string name;
    public int32 number;
    public Protobuf.EnumValueOptions? options;
    ...
    public override bool decode (Protobuf.DecodeBuffer buffer, ssize_t data_length = -1)
    {
        ...
        while (buffer.read_index < end)
        {
            ...
            if (field_number == 1 && wire_type == 2)
                ...
                this.options = new Protobuf.EnumValueOptions.from_data (buffer, (ssize_t) buffer.decode_varint ());
            else
                this.unknown_fields.prepend (buffer.decode_unknown_field (key));
        }
...
{
    public string name;
    public List<Protobuf.MethodDescriptorProto> method;
    public Protobuf.ServiceOptions? options;

    public ServiceDescriptorProto ()
    {
        this.name = "";
        this.method = new List<Protobuf.MethodDescriptorProto> ();
        this.options = null;
    }
    ...
    public override bool decode (Protobuf.DecodeBuffer buffer, ssize_t data_length = -1)
    {
        ...
        while (buffer.read_index < end)
        {
            ...
            if (field_number == 1 && wire_type == 2)
                ...
                this.method.append (new Protobuf.MethodDescriptorProto.from_data (buffer, (ssize_t) buffer.decode_varint ()));
            else if (field_number == 3 && wire_type == 2)
                this.options = new Protobuf.ServiceOptions.from_data (buffer, (ssize_t) buffer.decode_varint ());
            else
                this.unknown_fields.prepend (buffer.decode_unknown_field (key));
        }
    ...
    public override size_t encode (Protobuf.EncodeBuffer buffer)
    {
        ...
        for (unowned List<Protobuf.MethodDescriptorProto> i = this.method.last (); i != null; i = i.prev)
        {
    ...
    public override string to_string (string indent = "")
    {
        ...
        text += indent + "name: %s\n".printf (Protobuf.string_to_string (this.name));
        foreach (unowned Protobuf.MethodDescriptorProto v in this.method)
        {
            text += indent + "method {\n";
            text += "%s".printf (v.to_string (indent + "  "));
            text += indent + "}\n";
...
public class MethodDescriptorProto : Protobuf.Message
{
    ...
    public Protobuf.MethodOptions? options;
    ...
    public override bool decode (Protobuf.DecodeBuffer buffer, ssize_t data_length = -1)
    {
        ...
        while (buffer.read_index < end)
        {
            ...
            if (field_number == 1 && wire_type == 2)
                ...
                this.options = new Protobuf.MethodOptions.from_data (buffer, (ssize_t) buffer.decode_varint ());
            else
                this.unknown_fields.prepend (buffer.decode_unknown_field (key));
        }
...
public class FileOptions : Protobuf.Message
{
    ...
    public FileOptions ()
    {
        ...
        this.optimize_for = Protobuf.FileOptions.OptimizeMode.SPEED;
        this.go_package = "";
        this.cc_generic_services = false;
        this.java_generic_services = false;
        this.py_generic_services = false;
        this.uninterpreted_option = new List<Protobuf.UninterpretedOption> ();
    }
    ...
    public override bool decode (Protobuf.DecodeBuffer buffer, ssize_t data_length = -1)
    {
        ...
        while (buffer.read_index < end)
        {
            ...
            if (field_number == 1 && wire_type == 2)
                ...
                this.optimize_for = (Protobuf.FileOptions.OptimizeMode) buffer.decode_varint ();
                ...
                this.uninterpreted_option.append (new Protobuf.UninterpretedOption.from_data (buffer, (ssize_t) buffer.decode_varint ()));
            else
                this.unknown_fields.prepend (buffer.decode_unknown_field (key));
        }
    ...
    public override size_t encode (Protobuf.EncodeBuffer buffer)
    {
        ...
        foreach (var f in this.unknown_fields)
            n_written += buffer.encode_unknown_field (f);
        for (unowned List<Protobuf.UninterpretedOption> i = this.uninterpreted_option.last (); i != null; i = i.prev)
        {
        ...
        if (this.optimize_for != Protobuf.FileOptions.OptimizeMode.SPEED)
        {
    ...
    public override string to_string (string indent = "")
    {
        ...
        text += indent + "optimize_for: %s\n".printf (Protobuf.FileOptions.OptimizeMode_to_string (this.optimize_for));
        ...
        foreach (unowned Protobuf.UninterpretedOption v in this.uninterpreted_option)
        {
...
public class FieldOptions : Protobuf.Message
{
    ...
    public Protobuf.FieldOptions.CType ctype;
    public bool packed;
    public bool lazy;
    ...
    public FieldOptions ()
    {
        this.ctype = Protobuf.FieldOptions.CType.STRING;
        this.packed = false;
        this.lazy = false;
    ...
    public override bool decode (Protobuf.DecodeBuffer buffer, ssize_t data_length = -1)
    {
        ...
        while (buffer.read_index < end)
        {
            ...
            if (field_number == 1 && wire_type == 0)
                this.ctype = (Protobuf.FieldOptions.CType) buffer.decode_varint ();
            else if (field_number == 2 && wire_type == 0)
    ...
    public override size_t encode (Protobuf.EncodeBuffer buffer)
    {
        ...
        if (this.ctype != Protobuf.FieldOptions.CType.STRING)
        {
    ...
    public override string to_string (string indent = "")
    {
        ...
        text += indent + "ctype: %s\n".printf (Protobuf.FieldOptions.CType_to_string (this.ctype));
...
public class UninterpretedOption : Protobuf.Message
{
    ...
    public List<Protobuf.UninterpretedOption.NamePart> name;
    ...
    {
        this.name = new List<Protobuf.UninterpretedOption.NamePart> ();
    ...
    public override bool decode (Protobuf.DecodeBuffer buffer, ssize_t data_length = -1)
    {
        ...
        while (buffer.read_index < end)
        {
            ...
            if (field_number == 2 && wire_type == 2)
                this.name.append (new Protobuf.UninterpretedOption.NamePart.from_data (buffer, (ssize_t) buffer.decode_varint ()));
            else if (field_number == 3 && wire_type == 2)
    ...
    public override size_t encode (Protobuf.EncodeBuffer buffer)
    {
        ...
        for (unowned List<Protobuf.UninterpretedOption.NamePart> i = this.name.last (); i != null; i = i.prev)
        {
    ...
    public override string to_string (string indent = "")
    {
        ...
        foreach (unowned Protobuf.UninterpretedOption.NamePart v in this.name)
        {
            text += indent + "name {\n";
            text += "%s".printf (v.to_string (indent + "  "));
            text += indent + "}\n";
...
public class SourceCodeInfo : Protobuf.Message
{
    ...
    public List<Protobuf.SourceCodeInfo.Location> location;

    public SourceCodeInfo ()
    {
        this.location = new List<Protobuf.SourceCodeInfo.Location> ();
    }
    ...
    public override bool decode (Protobuf.DecodeBuffer buffer, ssize_t data_length = -1)
    {
        ...
        while (buffer.read_index < end)
        {
            ...
            if (field_number == 1 && wire_type == 2)
                this.location.append (new Protobuf.SourceCodeInfo.Location.from_data (buffer, (ssize_t) buffer.decode_varint ()));
            else
                this.unknown_fields.prepend (buffer.decode_unknown_field (key));
        }
    ...
    public override size_t encode (Protobuf.EncodeBuffer buffer)
    {
        ...
        foreach (var f in this.unknown_fields)
            n_written += buffer.encode_unknown_field (f);
        for (unowned List<Protobuf.SourceCodeInfo.Location> i = this.location.last (); i != null; i = i.prev)
        {
    ...
    public override string to_string (string indent = "")
    {
        ...
        foreach (unowned Protobuf.SourceCodeInfo.Location v in this.location)
        {
