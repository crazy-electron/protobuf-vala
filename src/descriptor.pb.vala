...
public class FileDescriptorProto : Protobuf.Message
{
    ...
    public override bool decode (Protobuf.DecodeBuffer buffer, ssize_t data_length = -1)
    {
        ...
        while (buffer.read_index < end)
        {
            ...
            else if (field_number == 12 && wire_type == 2)
                this.syntax = buffer.decode_string ((size_t) buffer.decode_varint ());
            else
                this.unknown_fields.prepend (buffer.decode_unknown_field (key));
        }
    ...
    public override size_t encode (Protobuf.EncodeBuffer buffer)
    {
        ...
        if (this.syntax != "")
        {
            var syntax_length = buffer.encode_string (this.syntax);
            n_written += syntax_length;
            n_written += buffer.encode_varint (syntax_length);
            n_written += buffer.encode_varint (98);
        }
    ...
    public override string to_string (string indent = "")
    {
        ...
        text += indent + "syntax: %s\n".printf (Protobuf.string_to_string (this.syntax));
...
public class DescriptorProto : Protobuf.Message
{
    ...
    public DescriptorProto ()
    {
        ...
        this.oneof_decl = new List<OneofDescriptorProto> ();
        this.options = null;
    }
    ...
    public override bool decode (Protobuf.DecodeBuffer buffer, ssize_t data_length = -1)
    {
        ...
        while (buffer.read_index < end)
        {
            ...
            if (field_number == 1 && wire_type == 2)
                ...
                this.oneof_decl.append (new OneofDescriptorProto.from_data (buffer, (ssize_t) buffer.decode_varint ()));
            else if (field_number == 7 && wire_type == 2)
    ...
    public override size_t encode (Protobuf.EncodeBuffer buffer)
    {
        ...
        for (unowned List<OneofDescriptorProto> i = this.oneof_decl.last (); i != null; i = i.prev)
        {
            var oneof_decl_length = i.data.encode (buffer);
            n_written += oneof_decl_length;
            n_written += buffer.encode_varint (oneof_decl_length);
            n_written += buffer.encode_varint (66);
        }
        for (unowned List<EnumDescriptorProto> i = this.enum_type.last (); i != null; i = i.prev)
        {
    ...
    public override string to_string (string indent = "")
    {
        ...
        foreach (unowned OneofDescriptorProto v in this.oneof_decl)
        {
            text += indent + "oneof_decl {\n";
            text += "%s".printf (v.to_string (indent + "  "));
            text += indent + "}\n";
        }
        if (options != null)
...
public class FieldDescriptorProto : Protobuf.Message
{
    ...
    public int32 oneof_index;
    public bool has_oneof_index;
    ...
    public override size_t encode (Protobuf.EncodeBuffer buffer)
    {
        ...
        {
            n_written += buffer.encode_bool (this.proto3_optional);
        ...
        if (this.json_name != "")
        {
            var json_name_length = buffer.encode_string (this.json_name);
            n_written += json_name_length;
            n_written += buffer.encode_varint (json_name_length);
            n_written += buffer.encode_varint (82);
        }
        if (this.has_oneof_index)
        {
            n_written += buffer.encode_int32 (this.oneof_index);
    ...
    public override string to_string (string indent = "")
    {
        ...
        text += indent + "oneof_index: %s\n".printf (this.oneof_index.to_string ());
        text += indent + "has_oneof_index: %s\n".printf (this.has_oneof_index.to_string ());
        text += indent + "json_name: %s\n".printf (Protobuf.string_to_string (this.json_name));
        if (options != null)
        {
            text += indent + "options {\n";
            text += "%s".printf (this.options.to_string (indent + "  "));
        ...
        text += indent + "proto3_optional: %s\n".printf (this.proto3_optional.to_string ());

        return text;
    }
}

public class OneofDescriptorProto : Protobuf.Message
{
    public string name;
    ...
    public OneofDescriptorProto.from_data (Protobuf.DecodeBuffer buffer, ssize_t data_length = -1)
    {
        decode (buffer, data_length);
    }
    ...
    public override bool decode (Protobuf.DecodeBuffer buffer, ssize_t data_length = -1)
    {
        ...
        while (buffer.read_index < end)
        {
            ...
            if (field_number == 1 && wire_type == 2)
                ...
                this.options = new OneofOptions.from_data (buffer, (ssize_t) buffer.decode_varint ());
            else
                this.unknown_fields.prepend (buffer.decode_unknown_field (key));
        }
...
public class MessageOptions : Protobuf.Message
{
    ...
    public override bool decode (Protobuf.DecodeBuffer buffer, ssize_t data_length = -1)
    {
        ...
        while (buffer.read_index < end)
        {
            ...
            if (field_number == 1 && wire_type == 0)
                ...
                this.map_entry = buffer.decode_bool ();
            else if (field_number == 999 && wire_type == 2)
                this.uninterpreted_option.append (new UninterpretedOption.from_data (buffer, (ssize_t) buffer.decode_varint ()));
            else
                this.unknown_fields.prepend (buffer.decode_unknown_field (key));
    ...
    public override size_t encode (Protobuf.EncodeBuffer buffer)
    {
        ...
        {
            n_written += buffer.encode_bool (this.map_entry);
    ...
    public override string to_string (string indent = "")
    {
        ...
        text += indent + "map_entry: %s\n".printf (this.map_entry.to_string ());
        foreach (unowned UninterpretedOption v in this.uninterpreted_option)
        {
            text += indent + "uninterpreted_option {\n";
            text += "%s".printf (v.to_string (indent + "  "));
...
public class OneofOptions : Protobuf.Message
{
    public List<UninterpretedOption> uninterpreted_option;
    ...
    public OneofOptions.from_data (Protobuf.DecodeBuffer buffer, ssize_t data_length = -1)
    {
        decode (buffer, data_length);
    }
